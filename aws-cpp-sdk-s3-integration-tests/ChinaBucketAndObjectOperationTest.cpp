...
namespace
{
    ...
    static const char* ALLOCATION_TAG = "ChinaBucketAndObjectOperationTest";
    ...
    class ChinaBucketAndObjectOperationTest : public ::testing::Test
    {
    public:
    ...
    std::shared_ptr<S3Client> ChinaBucketAndObjectOperationTest::Client(nullptr);
    //std::shared_ptr<S3Client> ChinaBucketAndObjectOperationTest::oregonClient(nullptr);
    std::shared_ptr<HttpClientFactory> ChinaBucketAndObjectOperationTest::ClientFactory(nullptr);
    std::shared_ptr<HttpClient> ChinaBucketAndObjectOperationTest::m_HttpClient(nullptr);
    std::shared_ptr<Aws::Utils::RateLimits::RateLimiterInterface> ChinaBucketAndObjectOperationTest::Limiter(nullptr);
    Aws::String ChinaBucketAndObjectOperationTest::TimeStamp("");

    TEST_F(ChinaBucketAndObjectOperationTest, TestInterrupt)
    {
        ...
        bucketConfiguration.SetLocationConstraint(BucketLocationConstraint::cn_north_1);
    ...
    TEST_F(ChinaBucketAndObjectOperationTest, TestBucketCreationAndListing)
    {
    ...
    TEST_F(ChinaBucketAndObjectOperationTest, TestBucketLocation)
    {
        ...
        auto locationOutcome = Client->GetBucketLocation(locationRequest);
        ASSERT_TRUE(locationOutcome.IsSuccess());
        ASSERT_EQ(locationOutcome.GetResult().GetLocationConstraint(), BucketLocationConstraint::cn_north_1);
    ...
    TEST_F(ChinaBucketAndObjectOperationTest, TestObjectOperations)
    {
        ...
        std::shared_ptr<Aws::IOStream> objectStream = Aws::MakeShared<Aws::StringStream>("ChinaBucketAndObjectOperationTest");
    ...
    TEST_F(ChinaBucketAndObjectOperationTest, TestKeysWithCrazyCharacterSets)
    {
    ...
    TEST_F(ChinaBucketAndObjectOperationTest, TestObjectOperationsWithPresignedUrls)
    {
    ...
    TEST_F(ChinaBucketAndObjectOperationTest, TestMultiPartObjectOperations)
    {
    ...
    TEST_F(ChinaBucketAndObjectOperationTest, TestThatErrorsParse)
    {
